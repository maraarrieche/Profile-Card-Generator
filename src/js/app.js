...
function render(variables = {}) {
  // eslint-disable-next-line console.log("These are the current variables: ", variables); //print on the console
    ...
    variables.country == null ? "Country" : variables.country
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href="https://twitter.com/${
              variables.twitter == null ? "maraarrieche" : variables.twitter
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github == null ? "maraarrieche" : variables.github
            }
            ...
            <li><a href="https://instagram.com/${
              variables.instagram == null ? "maraarrieche" : variables.instagram
